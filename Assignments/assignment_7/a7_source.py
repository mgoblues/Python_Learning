...
def get_escape_velocity(main_mass, distance_from_center):
...
def time_until_destination(time_step, ship_mass, engine_force, target_distance):
    ...
    iterations = 0
    print("=========================")
    print(str(traveled_distance) + " traveled")
    print("=========================")
    print(str(target_distance) + " target")
    print("=========================")
    ...
    while traveled_distance < target_distance:
        if iterations > MAX_ITERATIONS:
            ...
            print("got " + str(traveled_distance) + " m")
            print("=========================")
            break
...
escape_velocity = get_escape_velocity(EARTH['mass'] , EARTH['radius'])
print("The escape velocity at the surface of the Earth is: "+ str(escape_velocity) + "m/ s^2")
